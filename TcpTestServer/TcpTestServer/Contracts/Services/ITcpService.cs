...
public interface ITcpService
{
    ...
    Task<ConnectionStatus> ConnectAsync(string hostName, int port, int timeoutSec);
    ...
    /// <returns>接続状態</returns>
    public Task<ConnectionStatus> ReconnectAsync(string hostName, int port, int timeoutSec,
        int maxAttempts = 3);
